## Choose resolution for clustering using chooseR package
library(Seurat)
library(ggplot2)
library(tidyverse)

setwd("/Users/jinhuixin/Master/thesis/cluster.stability/") # path of chooseR
source("/Users/jinhuixin/Master/thesis/cluster.stability/R/pipeline.R") # script of chooseR
`%>%` <- magrittr::`%>%`

obj <- bs1140.seurat # seurat object after preprocess, filtering, PCA, UMAP and findneighbors
...
assay <- "SCT"
reduction <- "pca"
results_path <- "/Users/jinhuixin/Master/thesis/BS1140/scRNA_ana/chooseR/"
